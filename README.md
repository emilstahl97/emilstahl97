...
[![My Skills](https://skillicons.dev/icons?i=bash,c,css,docker,elixir,express,fastapi,figma,flask,git,html,java,javascript,kafka,linux,materialui,mongodb,mysql,nodejs,py,react,redis,scala,vim,vscode)](https://skillicons.dev)
